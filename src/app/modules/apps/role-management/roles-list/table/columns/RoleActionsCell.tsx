...
import { deleteRole } from "../../core/_requests"; // Update function for roles
...
const RoleActionsCell: FC<Props> = ({ id, role_name, is_active }) => {
  ...
  const viewDetails = () => {
    ...
    console.log(`Viewing details for role ID: ${id}, Role Name: ${role_name}`);
  };
